...
showEndPage: function(numCorrect, numIncorrect, numUnanswered) {
    ...
    $("#timer").empty();
    $("#timer").hide();
    $("#correct-answers").text("Woo-hoo:" + numCorrect);
    $("#incorrect-answers").text("D'oh!:" + numIncorrect);
    $("#unanswered").text("Meh:" + numUnanswered);
  }
}
  ...
  [
    {
      ...
      answers: ["Five Thousand", "Nine Thousand", "Two Million","two"],
      correct: "Two"
    },
  
    {
      question: "How many muscle do you have in all your finger?",
      answers: ["0","22","10","30"],
      correct: "o"
    },
    {
      question: "How many actors played Harry Potter in Harry Potter movies?",
      answers: ["Two", "Five", "One","Eight"],
      correct: "Five"
    },
    {
      question: "How many toes does a two toed sloth have?",
      answers: ["Ten", "None", "Two","It's etiher six or eight"],
      correct: "Its either six or eight"
    },
]